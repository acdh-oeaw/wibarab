  ...
  return (
    <PageMainContent>
      <PageHeroSection>
        ...
        <PageHeroLeadIn>
          The linguistic and socio-historical realities behind the millennia-old dichotomous concept
          of nomadic and sedentary people in the Middle East and North Africa
        </PageHeroLeadIn>
      </PageHeroSection>
      <PageSection>
        ...
        <p className="leading-8 text-size-text text-text">
          ...
          cross-dialectal comparisons, particularly with regard to phonological, morphological,
          syntactical, phraseological and lexical features
        </p>
      </PageSection>
      <Spacer />
      <PageSection>
